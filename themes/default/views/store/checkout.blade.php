            ...
            <div class="my-4 p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="grid gap-6 sm:grid-cols-2 ">
                        ...
                        <div class="mb-4 ml-2">
                            ...
                            @if (config('SETTINGS::PAYMENTS:PAYPAL:SECRET') || config('SETTINGS::PAYMENTS:PAYPAL:SANDBOX_SECRET'))
                                <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                                    <input type="radio" class="text-purple-600 form-radio focus:border-purple-400 "
                                        x-model="paymentMethod" type="radio" id="paypal" value="paypal"
                                        name="payment_method">
                            ...
                            @if (config('SETTINGS::PAYMENTS:STRIPE:TEST_SECRET') || config('SETTINGS::PAYMENTS:STRIPE:SECRET'))
                                <label class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400">
                                    <input type="radio" class="text-purple-600 form-radio focus:border-purple-400 "
                                        x-model="paymentMethod" type="radio" id="stripe" value="stripe"
                                        name="payment_method">
                    ...
                    <div class="w-full overflow-hidden">
                        ...
                        <button type="submit" :disabled="(!payment_method || clicked) && {{ !$productIsFree }}" :class="(!payment_method || clicked) && {{ !$productIsFree }} ? 'disabled' : ''" @click="clicked = true" x-on:click="clicked = true; $refs.form.submit()"
