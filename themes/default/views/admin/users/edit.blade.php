                ...
                <x-card>
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <x-label title="Pterodactyl ID"
                            ...
                            <x-input value="{{ $user->pterodactyl_id }}" id="pterodactyl_id" name="pterodactyl_id"
                                type="number" />
                        </x-label>
                        <x-label title="{{ CREDITS_DISPLAY_NAME }}">
                            <x-input value="{{ $user->credits }}" min="0" max="99999999" step="any"
                        ...
                        <x-label title="Referral Code">
                            <x-input value="{{ $user->referral_code }}" id="referral_code" name="referral_code"
                                type="text" />
                        </x-label>
                    </div>
