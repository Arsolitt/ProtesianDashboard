                    ...
                    <div class="ticket-info">
                        ...
                        <p><b>{{ __("Priority") }}:</b>
                                        @switch($ticket->priority)
                                            @case("Low")
                                                <span class="text-green-700 bg-green-100 dark:bg-green-500/20 dark:text-green-500 px-2 py-1 font-semibold leading-tight rounded-full text-xs">{{__("Low")}}</span>
                                                @break
                                            @case("Medium")
                                               <span class="text-yellow-700 bg-yellow-100 dark:bg-yellow-500/20 dark:text-yellow-500 px-2 py-1 font-semibold leading-tight rounded-full text-xs">{{__("Medium")}}</span>
                                                @break
                                            @case("High")
                                               <span class="text-red-700 bg-red-100 dark:bg-red-500/20 dark:text-red-500 px-2 py-1 font-semibold leading-tight rounded-full text-xs">{{__("High")}}</span>
                                                @break
                                        @endswitch
                                    </p>
                        <p>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h5 class="flex items-center gap-2"><img
                                            ...
                                            class="inline-block rounded-full" alt="User Image">
                                        <a
                                            href="/admin/users/{{ $ticketcomment->user->id }}">{{ $ticketcomment->user->name }}</a>
