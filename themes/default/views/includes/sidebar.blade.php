<div class="py-4 text-gray-500 dark:text-gray-400">
    <a class="flex gap-4 items-center ml-6 text-lg font-bold text-gray-800 dark:text-gray-200"
        href="{{ route('welcome') }}">
        @if (\Illuminate\Support\Facades\Storage::disk('public')->exists('icon.png'))
            <img src="{{ asset('images/cube.png') }}" alt="{{ config('app.name', 'ControlPanel.gg') }} Logo"
                class="rounded-lg w-9 h-9">
        @endif
        <span class="text-2xl font-bold" style="font-family: 'Open Sans', sans-serif;">Protes<span class="cyan-dot cyan-dot-small"><i>i</i></span>aN</span>
        <style>
                .cyan-dot {
                    position: relative;
    ...
    <ul>
        ...
        @if (Auth::user()->role == 'admin')
            ...
            <li class="relative px-6 py-3">
                ...
                <ul x-cloak x-cloak x-show="isManagementMenuOpen"
                    x-transition:enter="transition-all ease-in-out duration-300"
                    x-transition:enter-start="opacity-0 max-h-0"
                    x-transition:enter-end="opacity-100 max-h-[59rem]"
                    x-transition:leave="transition-all ease-in-out duration-300"
                    x-transition:leave-start="opacity-100 max-h-[59rem]"
                    ...
                    <li
                        ...
                        <a class="w-full inline-block"
                            href="{{ route('admin.vouchers.index') }}">{{ __('Vouchers') }}</a>
                    </li>
                    <li
                        ...
                        <a class="w-full inline-block"
                            href="{{ route('admin.partners.index') }}">{{ __('Partners') }}</a>
                    </li>
                    <li
                    ...
                    <li
                        ...
                        <a class="w-full inline-block"
                            href="{{ route('admin.legal.index') }}">{{ __('Legal Sites') }}</a>
                    </li>
                </ul>
            </li>
            <li class="relative px-6 py-3">
