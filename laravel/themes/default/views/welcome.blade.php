                    ...
                    <div class="tab-wrapper" style="max-height: 250px; max-width: 600px; height: 100%; width: 100%">
                        <div id="tabcontent1" data-tab="1" class="tabcontent">
                            ...
                            <p class="lg:text-2xl">
                                📌{{ __('Да, хостинг.')}}<br>
                                📌{{ __('Да, не лучший.')}}<br>
                                📌{{ __('Да, не самый дешёвый.')}}<br>
                                📌{{ __('Да, у нас нет свапа.')}}<br>
                                📌{{ __('Да, у нас нет оверсела.')}}<br>
                                📌{{ __('Да, мы не ограничиваем процессор на узлах.')}}
                            </p>
                        </div>
                        <div id="tabcontent2" data-tab="2" class="tabcontent">
                            ...
                            <p class="lg:text-2xl">
                                ⚙️{{ __('А в поддержке у нас сидят только умные и красивые.') }}<br>
                                ⚙️{{ __('На любой вопрос ответят, даже сборку вам помогут собрать.') }}<br>
                                ⚙️{{ __('И расскажут о древних шаманских техниках оптимизации серверов!') }}<br>
                            </p>
                        </div>
                    </div>
