        ...
        <div class="grid gap-x-4 md:grid-cols-2 lg:grid-cols-4">
            <x-card title="Mail" class="p-0 shadow-none" style="padding: 0 !important;">
                ...
                <x-label title="Mail Host">
                    <x-input id="mailhost" name="mailhost" type="text"
                        value="{{ config('SETTINGS::MAIL:HOST') }}" />
                </x-label>
                <x-label title="Mail Port">
                    <x-input id="mailport" name="mailport" type="text"
            ...
            <x-card title="Discord" class="p-0 shadow-none" style="padding: 0 !important;">
                ...
                <x-label title="Discord Client Secret">
                    <x-input x-todo="discord-client-secret" id="discord-client-secret" name="discord-client-secret"
                ...
                <x-label title="Discord Invite URL">
                    <x-input x-todo="discord-invite-url" id="discord-invite-url" name="discord-invite-url"
            ...
            <x-card title="ReCaptcha" class="p-0 shadow-none" style="padding: 0 !important;">
                ...
                <x-label title="ReCaptcha Site Key">
                    <x-input x-todo="recaptcha-site-key" id="recaptcha-site-key" name="recaptcha-site-key"
            ...
            <x-card title="Referral System" class="p-0 shadow-none" style="padding: 0 !important;">
                ...
                <x-checkbox title="Always Give Commission" value="true" id="always_give_commission"
                    name="always_give_commission"
                    checked="{{ config('SETTINGS::REFERRAL::ALWAYS_GIVE_COMMISSION') }}">
                    {{ __('Should users recieve the commission only for the first payment, or for every payment?') }}
                </x-checkbox>

                <x-label title="Mode">
                    <x-select id="referral_mode" class="custom-select" name="referral_mode" required
                        autocomplete="off">
                ...
                <x-label title="Referral reward in percent">
                    <x-input x-todo="referral_percentage" id="referral_percentage" name="referral_percentage"
                ...
                <x-label title="Allowed">
                    <x-select id="referral_allowed" class="custom-select" name="referral_allowed" required
                        autocomplete="off">
