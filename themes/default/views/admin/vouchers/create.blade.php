    ...
    <x-container title="Vouchers Details">
        ...
        <x-card>
            <form action="{{ route('admin.vouchers.store') }}" method="POST">
                ...
                <x-label title="Memo">
                    <x-input value="{{ old('memo') }}" placeholder="{{ __('Summer break voucher') }}" id="memo"
                        name="memo" type="text"></x-input>
                    @slot('text')
                ...
                <x-label title="Expires At">
                    <x-input value="{{ old('expires_at') }}" name="expires_at" placeholder="dd-mm-yyyy hh:mm:ss"
                        type="text" id="expires_at"></x-input>
                    @slot('text')
