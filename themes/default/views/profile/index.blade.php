                    ...
                    <x-alert class="mt-6" type="danger" title="Required Discord verification">
                        <p>
                            ...
                            <a class="text-primary underline"
                                href="{{ route('auth.redirect') }}">{{ __('Login with discord') }}</a>
                            <br>
                                        ...
                                        <div class="e-profile">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <label class="block text-sm mb-3">
                                                    <span
                                                        class="text-gray-700 dark:text-gray-400">{{ __('Name') }}</span>
                                                ...
                                                <label class="block text-sm mb-3">
                                                    <span
                                                        class="text-gray-700 dark:text-gray-400">{{ __('Email') }}</span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label class="block text-sm mb-3">
                                                                        <span
                                                                            class="text-gray-700 dark:text-gray-400">{{ __('Current Password') }}</span>
