    ...
    public function dataTable(Request $request)
    {
        ...
        return datatables($query)
            ...
            ->addColumn('status', function (Server $server) {
                $labelColor = $server->isSuspended() ? 'text-yellow-700 bg-yellow-100 dark:bg-yellow-500/20 dark:text-yellow-500' : 'text-green-700 bg-green-100 dark:bg-green-700 dark:text-green-500';
